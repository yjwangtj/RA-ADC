...
# Loading the database dictionary
...
# Searching for the most similar embedding with cosine similarity
alpha = 0 # Weight of XModal embeddings
max_similarity = -1
retrieved_text = None
...
for idx, img_emb in enumerate(embedding_dict.keys()):
    ...
    if similarity > max_similarity:
        ...
        retrieved_image_idx = idx + 1  # Keep track of the image index
